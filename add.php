...
<head>
    ...
    <title>Add | Sanapati Cendekia Center</title>
</head>
    ...
    <div class="d-flex justify-content-center">
        <div class="col-lg-11 p-5 justify-content-center">
            ...
            <article class="card-body bg-dark">
                <h1 class="card-title text-center my-4 text-light">Add</h1>
                ...
                <div class="d-flex justify-content-center">
                    <div class="col-lg-6">
                        <form class="" method="post" action="semiapi.php" enctype="multipart/form-data">
                            <input name="kode" class="form-control mb-2" placeholder="Kode Mata Kuliah" type="text"
                                required>
